...
namespace PsMachine.Modbus
{
	...
	/// </summary>
	public class PsModbusTcpPoint<T> : PsModbusTcpPoint
	{
		...
		public PsModbusTcpPoint(PsModbusTcpStation myStation, string myCode)
	...
	/// <summary>Modbus 点位
	/// </summary>
	public abstract class PsModbusTcpPoint : PsWorkStationPointBase<PsModbusTcpStation, PsModbusTcpPoint>
	{
		public PsModbusTcpPoint(PsModbusTcpStation myStation, string myCode)
			: base(myStation, myCode)
		{
