...
namespace HyWPF.UCL
{
	public class StationToolBar : ToolBar
	{
		public static DependencyProperty DataSourceProperty = DependencyProperty.Register("DataSource", typeof(object), typeof(StationToolBar), new PropertyMetadata(null, DataSource_PropertyChangedCallback));
		...
		{
			StationToolBar myThis = (StationToolBar)d;
